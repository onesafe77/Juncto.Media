      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-3 space-y-1">
          ...
          <div className="pt-8 mt-8 border-t border-blue-gray/30">
            <Link to="/" className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold text-accent hover:bg-accent/10 transition-colors">
              ...
              <div>
                ...
                <form className="space-y-6 max-w-md">
                  <div>
                    ...
                    <input type="text" defaultValue="Budi Santoso" className="w-full px-4 py-2 bg-off-white border border-blue-gray/30 rounded-lg focus:border-primary outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-dark mb-2">Email</label>
                    <input type="email" defaultValue="budi@example.com" disabled className="w-full px-4 py-2 bg-blue-gray/10 border border-blue-gray/30 rounded-lg text-text-medium cursor-not-allowed" />
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Contoh: Peneliti Hukum" className="w-full px-4 py-2 bg-off-white border border-blue-gray/30 rounded-lg focus:border-primary outline-none" />
                  </div>
